...
Variation that uses the Sprod cell similarity graph.

Example: python spatial_conformal_uncertainty_sprod.py Dataset15graph 10 10 4 1 knn_spage_tangram --save_intermediate --non-symmetric
'''
...
# Read in Sprod adjacency graph_time
load_spatial_graph(adata, "DataUpload/"+dataset_name+"/sprod_graph.npz")
...
for method in methods:
    ...
    for i, fold in enumerate(folds):
        ...
        conformalize_spatial_uncertainty(sub_adatac, predicted, calib_genes, weight="spatial_connectivities", mean_normalized=False, add_one=True,
